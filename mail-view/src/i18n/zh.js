const zh = {
    ...
    privateMailbox: '私密邮箱',
    mailInYourControl: '邮件，由你掌控',
    simpleAndFocused: '简单 · 专注',
    mailReady: '邮箱已就绪',
    mailWithoutLimits: '不被边界定义的邮箱',
    featureSecure: '安全私密',
    featureFast: '快速收信',
    featureGlobal: '随时访问',
    orDivider: '或者',
    ...
    layoutTop: '顶栏导航',
    layoutIsland: '浮岛导航',
    islandNavigation: '浮岛导航中心',
    moreNavigation: '更多',
    mailServices: '邮箱服务',
    close: '关闭',
    domainManagement: '域名管理',
    domainManagementDesc: '在线管理可用域名，支持启用/禁用/新增/删除/排序，保存后生效；配置此处后 wrangler.toml 的 domain 变量可留空。',
    domainList: '域名列表',
    domainPlaceholder: '输入域名，如 example.com',
    domainExists: '该域名已存在',
    noDomains: '暂无域名，请添加',
    domainOrderHint: '拖动手柄或使用上下按钮调整顺序，第一个为注册页默认后缀',
    domainEnabledCount: '已启用 {enabled} / 共 {total}',
    dragToSort: '拖动排序',
    moveUp: '上移',
    moveDown: '下移',
