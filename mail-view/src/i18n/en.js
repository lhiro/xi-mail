const en = {
    ...
    mailSource: 'Source',
    mailSourceGmail: 'Gmail',
    mailSourceOutlook: 'Outlook',
    mailSourceXiMail: 'Xi-Mail',
    ...
    privateMailbox: 'Private mailbox',
    mailInYourControl: 'Mail, under your control',
    simpleAndFocused: 'Simple · Focused',
    mailReady: 'Mailbox ready',
    mailWithoutLimits: 'Mail without boundaries',
    featureSecure: 'Secure & private',
    featureFast: 'Fast delivery',
    featureGlobal: 'Access anywhere',
    orDivider: 'OR',
    ...
    layoutTop: 'Top Bar',
    layoutIsland: 'Floating Island',
    islandNavigation: 'Navigation Island',
    moreNavigation: 'More',
    mailServices: 'Mail Services',
    close: 'Close',
    domainManagement: 'Domain Management',
    domainManagementDesc: 'Manage available domains online. Supports enable/disable/add/delete/reorder. Once configured here, the domain variable in wrangler.toml can be left empty.',
    ...
    domainOrderHint: 'Drag the handle or use the arrows to reorder. The first one is the default suffix on the register page',
    domainEnabledCount: '{enabled} enabled / {total} total',
