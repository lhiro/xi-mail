const en = {
	...
	mailAccountNotFound: 'The mailbox account does not exist or does not belong to the current user',
	mailProviderUnsupported: 'Unsupported mail provider',
	mailConnectionCombinationUnsupported: 'The provider, protocol, and authentication type are not compatible',
	mailConnectionSettingsInvalid: 'Mail connection settings must be an object',
	mailConnectionExists: 'This mailbox already has a mail connection',
	mailConnectionNotFound: 'Mail connection does not exist',
	mailCredentialRequired: 'A mail credential is required',
	mailCredentialKeyMissing: 'Mail credential encryption key is not configured',
	mailAdapterUnsupported: 'This mail connection does not have a configured adapter',
	mailOAuthProviderUnsupported: 'This mail OAuth authorization flow is not supported',
	mailOAuthConfigMissing: 'Mail OAuth configuration is missing',
	mailOAuthStateInvalid: 'Mail OAuth state is invalid or expired',
	mailOAuthTokenExchangeFailed: 'Mail OAuth token exchange failed',
	mailOAuthRefreshTokenMissing: 'Mail OAuth did not return a refresh token. Please authorize again and allow offline access',
	mailOAuthSuccess: 'Mail OAuth authorization succeeded',
	mailOAuthReturn: 'Return to Xi-Mail',
	mailImportOwnerNotFound: 'The import owner account does not exist',
