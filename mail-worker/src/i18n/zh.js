const zh = {
	...
	unauthorized: '权限不足',
	mailAccountNotFound: '邮箱账号不存在或不属于当前用户',
	mailProviderUnsupported: '不支持的邮箱服务商',
	mailConnectionCombinationUnsupported: '服务商、协议和认证方式组合不兼容',
	mailConnectionSettingsInvalid: '邮箱连接配置必须是对象',
	mailConnectionExists: '该邮箱账号已经存在外部邮箱连接',
	mailConnectionNotFound: '邮箱连接不存在',
	mailCredentialRequired: '必须提供邮箱凭据',
	mailCredentialKeyMissing: '尚未配置邮箱凭据加密密钥',
	mailAdapterUnsupported: '该邮箱连接尚未配置可用适配器',
	mailOAuthProviderUnsupported: '不支持该邮箱 OAuth 授权方式',
	mailOAuthConfigMissing: '邮箱 OAuth 配置缺失',
	mailOAuthStateInvalid: '邮箱 OAuth 授权状态无效或已过期',
	mailOAuthTokenExchangeFailed: '邮箱 OAuth 换取令牌失败',
	mailOAuthRefreshTokenMissing: '邮箱 OAuth 未返回刷新令牌，请重新授权并选择同意离线访问',
	mailOAuthSuccess: '邮箱 OAuth 授权成功',
	mailOAuthReturn: '返回 Xi-Mail',
	mailImportOwnerNotFound: '导入归属账号不存在',
